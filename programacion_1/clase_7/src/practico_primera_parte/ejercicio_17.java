...
public class ejercicio_17 {
	...
	public static void agregar_a_arreglo_pares(int [] arrint, int [] pares, int todos){
		for (int indice = 0; indice < arrint.length ; indice++) {
			if ((arrint[indice] % 2)==0) {
				todos = indice;
				for (int par = 0; par < arrint.length; par++) {
